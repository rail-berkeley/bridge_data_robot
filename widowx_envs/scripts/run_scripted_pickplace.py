...
if __name__ == '__main__':
    ...
    parser.add_argument("-o", "--object", choices=('black checkers piece', 'white checkers piece'), default='black checkers piece') 
    parser.add_argument("-r", "--random-object-selection", default=False)
    parser.add_argument("-d", "--data-save-directory", type=str, 
                        default="/home/robonet/trainingdata/scripted_demos/raw_data") # need to change this 
    ...
    if args.detector == 'ViLD':
       object_detector = ObjectDetectorViLD(env, args.image_save_directory, image_xyz=env.startpos)
       transmatrix = KMEANS_RGB_TO_ROBOT_TRANSMATRIX # need to fix 
    ...
    for i in range(args.num_trajectories):
        ...
        if args.object:
            ...
            keys = filter(lambda x: grasp_object_name in x, centroids.keys())
